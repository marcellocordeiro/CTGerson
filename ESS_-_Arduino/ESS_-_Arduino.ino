...
thing.init("ALARME DAORA");
    thing.registerBoolData(ALARM_STATUS_NAME, ALARM_STATUS_ID, KNOT_TYPE_ID_SWITCH,
        KNOT_UNIT_NOT_APPLICABLE, alarm_status_read, alarm_status_write);
        
   // thing.registerFloatData(LON_NAME, LON_ID, KNOT_TYPE_ID_LONGITUDE,
     //   KNOT_UNIT_LONGITUDE_DEGREE, lon_read,lon_write);
        
    thing.registerFloatData(LAT_NAME,LAT_ID, KNOT_TYPE_ID_LATITUDE,
        KNOT_UNIT_LATITUDE_DEGREE, lat_read,lat_write);
